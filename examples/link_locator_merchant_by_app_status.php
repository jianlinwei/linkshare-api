...
$merchantId = getenv('EXAMPLE_APP_STATUS') ? getenv('EXAMPLE_APP_STATUS') : 'approved';
...
$apiCaller->makeRequest(
    $linkLocator,
    function (LinkLocator $provider) use ($appStatus) {
        $provider->merchantByAppStatus($appStatus);
    }
);